...
export const sampleProxyReportData: ProxyReportData = {
  ...
  preciousMetalPresent: {
    items: [
      { name: "Gold", symbol: "Ag", ppm: 17, color: "#FFB300" },
      { name: "Platinum", symbol: "Pl", ppm: 9, color: "#7A7A7A" },
      { name: "Rhodium", symbol: "Rh", ppm: 3, color: "#A53D3D" },
      { name: "Silver", symbol: "Au", ppm: 3, color: "#B8C9DB" },
      { name: "Palladium", symbol: "Pd", ppm: 2, color: "#EBC190" },
      { name: "Osmium", symbol: "Os", ppm: 2, color: "#617161" },
      { name: "Ruthenium", symbol: "Ru", ppm: 2, color: "#D19A8C" },
