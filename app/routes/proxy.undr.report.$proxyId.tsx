...
export const loader = async ({ params, request }: LoaderFunctionArgs) => {
  ...
  const template = `
<link rel="stylesheet" href="${appUrl}/proxy-report.css?v=20260529-continuous-pdf-v1">
...
<script src="${appUrl}/proxy-report-init.js?v=20260529-continuous-pdf-v1" defer></script>
`;
