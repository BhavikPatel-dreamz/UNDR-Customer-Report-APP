        ...
        <div className="container">
          <div className="additional_resources_body">
            ...
            <div className="additional_resources_disclaimer">
              ...
              <p>
                The resources and information provided in this section are offered solely for general educational and
                informational purposes. Any mention of regulatory agencies, professional services, service providers,
                industries, costs, potential sources, or potential next steps should not be construed as advice,
                recommendation, endorsement, regulatory guidance, compliance advice, diagnostic interpretation, or a
                substitute for consultation with qualified professionals. Before making decisions relating to land use,
                mineral exploration, environmental remediation, property transactions, health considerations, insurance,
                or financial investment, consult qualified licensed professionals and appropriate governmental
                authorities.
              </p>
            </div>
          </div>
